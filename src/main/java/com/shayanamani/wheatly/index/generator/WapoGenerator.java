...
package com.shayanamani.wheatly.index.generator;

import com.shayanamani.wheatly.collection.WashingtonPostCollection;
import com.shayanamani.wheatly.collection.WashingtonPostCollection.Document.WashingtonPostObject;
import com.shayanamani.wheatly.index.IndexCollection;
...
public class WapoGenerator extends LuceneDocumentGenerator<WashingtonPostCollection.Document> {
  ...
  public Document createDocument(WashingtonPostCollection.Document wapoDoc) {
    ...
    // Are we storing document similarityPair?
