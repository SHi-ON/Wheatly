...
import com.shayanamani.wheatly.collection.BaseFileSegment;
import com.shayanamani.wheatly.collection.DocumentCollection;
import com.shayanamani.wheatly.collection.SegmentProvider;
import com.shayanamani.wheatly.collection.SourceDocument;
import com.shayanamani.wheatly.util.mapper.DocumentMapper;
import com.shayanamani.wheatly.util.mapper.DocumentMapperContext;
...
public final class MapCollections {
  ...
  public static final class Args {
    ...
    @Option(name = "-collection", required = true, usage = "collection class in com.shayanamani.wheatly.collection")
    public String collectionClass;

    @Option(name = "-mapper", required = true, usage = "mapper class in com.shayanamani.wheatly.util.mapper")
    public String mapperClass;

    @Option(name = "-context", required = true, usage = "context class in com.shayanamani.wheatly.util.mapper")
  ...
  public MapCollections(Args args) throws Exception {
    ...
    this.collectionClass = Class.forName("com.shayanamani.wheatly.collection." + args.collectionClass);
    this.mapperClass = Class.forName("com.shayanamani.wheatly.util.mapper." + args.mapperClass);
    this.contextClass = Class.forName("com.shayanamani.wheatly.util.mapper." + args.contextClass);
