 ...
 * ranklib model to score the feature similarityPair
...
public class RankLibScorer {
  ...
  private static class ParseArgs {
    ...
    @Option(name = "-qrels", metaVar = "[file]", required = true, usage = "patht to the qrels file, needed for feature similarityPair")
    public String qrels= "";
  }
