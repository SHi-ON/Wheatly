...
package com.shawnazdam.wheatly.util;

import com.shawnazdam.wheatly.collection.BaseFileSegment;
import com.shawnazdam.wheatly.collection.DocumentCollection;
import com.shawnazdam.wheatly.collection.SegmentProvider;
import com.shawnazdam.wheatly.collection.SourceDocument;
import com.shawnazdam.wheatly.util.mapper.DocumentMapper;
import com.shawnazdam.wheatly.util.mapper.DocumentMapperContext;
...
public final class MapCollections {
  ...
  public static final class Args {
    ...
    @Option(name = "-collection", required = true, usage = "collection class in com.shawnazdam.wheatly.collection")
    public String collectionClass;

    @Option(name = "-mapper", required = true, usage = "mapper class in com.shawnazdam.wheatly.util.mapper")
    public String mapperClass;

    @Option(name = "-context", required = true, usage = "context class in com.shawnazdam.wheatly.util.mapper")
  ...
  public MapCollections(Args args) throws Exception {
    ...
    this.collectionClass = Class.forName("com.shawnazdam.wheatly.collection." + args.collectionClass);
    this.mapperClass = Class.forName("com.shawnazdam.wheatly.util.mapper." + args.mapperClass);
    this.contextClass = Class.forName("com.shawnazdam.wheatly.util.mapper." + args.contextClass);
