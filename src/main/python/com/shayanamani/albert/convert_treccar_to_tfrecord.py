...
import time
# local modules
import com.shayanamani.albert.tokenization as tokenization
import com.shayanamani.albert.trec_car_elements as trec_car_classes
...
flags.DEFINE_string(
    "output_foldfrom_cbor(cbor)er", None,
